...
\hypersetup{
	...
	pdfinfo={
		...
		Template.Version.Dev={7.1.0},
		Template.Version.Hash={28103170CEA6AB66E327FF25A17B3A5D},
		Template.Version.Release={7.1.0},
	...
	pdfproducer={Template-Informe v7.1.0 | (Pablo Pizarro R.) ppizarror.com},
...
\newcommand{\templatePortrait}{
	...
	\ifthenelse{\equal{\portraitstyle}{style4}}{
		...
		\checkextravarexist{\portraitimageF}{[portrait-style4] Defina la direccion de la imagen extra de la portada}
	...
	\ifthenelse{\equal{\portraitstyle}{style5}}{
		...
		\checkextravarexist{\portraitimageG}{[portrait-style5] Defina la direccion de la imagen extra de la portada}
	...
	\ifthenelse{\equal{\portraitstyle}{style6}}{
		...
		\checkextravarexist{\portraitimageH}{[portrait-style6] Defina la direccion de la imagen extra de la portada}
	...
	\ifthenelse{\equal{\portraitstyle}{style15}}{
		...
		\checkextravarexist{\portraitimageA}{[portrait-style15] Defina la direccion de la imagen extra de la portada}
		\checkextravarexist{\portraitimageparamsA}{[portrait-style15] Defina los parametros de la imagen extra de la portada}
		\checkextravarexist{\portraitimagerightA}{[portrait-style15] Defina la direccion de la imagen extra derecha de la portada}
	...
	\ifthenelse{\equal{\portraitstyle}{style16}}{
		...
		\checkextravarexist{\portraitbackgroundimageB}{[portrait-style16] Defina la direccion del fondo de la portada}
	...
	\ifthenelse{\equal{\portraitstyle}{style17}}{
		...
		\checkextravarexist{\portraitimageC}{[portrait-style17] Defina la direccion de la imagen extra de la portada}
	...
	\ifthenelse{\equal{\portraitstyle}{style18}}{
		...
		\checkextravarexist{\portraitimageD}{[portrait-style18] Defina la direccion de la imagen extra de la portada}
